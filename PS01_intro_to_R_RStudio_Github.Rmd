...
As long as you don't try anything fancy with git, this should be a simple matter of using the "Push" button in the Git pane. If successful, any changes you pushed back should now appear on your github repository for the project.
