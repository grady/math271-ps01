...
In the figure above, I am set up to commit my new solution Rmd and html files to git. There are also some changes made to the instructions html document, but by leaving the staging box unchecked I am choosing not to commit these changes at this time.
